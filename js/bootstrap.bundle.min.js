...
!function (t, e) {
    ...
    class Q extends R {
        ...
        _updateInterval() {
            const e = this._activeElement || t.findOne(
    ...
    class J extends R {
        ...
        show() {
            ...
            let e,
                i;
            this._parent && (e = t.find(".show, .collapsing", this._parent).filter(
                t => "string" == typeof this._config.parent
            ...
            effect: function (t) {
                var e = t.state,
                    ...
                    n = void 0 === i
                        ? "[data-popper-arrow]"
                        : i;
                null != n && ("string" != typeof n || (n = e.elements.popper.querySelector(n))) && _t(
                    e.elements.popper,
                    n
                ) && (e.elements.arrow = n)
            },
        ...
        return a
            ? Object.assign({}, A, (
                ...
                T[_] = m
                    ? "0"
                    : "",
                T.transform = (v.devicePixelRatio || 1) < 2
                    ? "translate(" + u + "px, " + p + "px)"
    ...
    var jt = {
            ...
            fn: function (t) {
                ...
                null != e.modifiersData.popperOffsets && (
                    e.styles.popper = Object.assign({}, e.styles.popper, It(Object.assign({}, c, {
                ...
                null != e.modifiersData.arrow && (
                    e.styles.arrow = Object.assign({}, e.styles.arrow, It(Object.assign({}, c, {
            ...
            : ht(e)
                ...
                : Ft(function (t) {
                    var e,
                        ...
                        a = -n.scrollLeft + zt(t),
                        l = -n.scrollTop;
                    return "rtl" === bt(s || i).direction && (a += Lt(
                        i.clientWidth,
                        s
                            ? s.clientWidth
                            : 0
        ...
        var i = e,
            ...
            y = function (t, e, i) {
                var n = "clippingParents" === e
                        ? function (t) {
                            var e = $t(wt(t)),
                                i = ["absolute", "fixed"].indexOf(bt(t).position) >= 0 && ht(t)
                                    ? Tt(t)
                                    : t;
                            return dt(i)
                                ? e.filter((function (t) {
                ...
                dt(v)
                    ? v
                    : v.contextElement || yt(t.elements.popper),
                r,
                l
            ),
            w = mt(_),
    ...
    class Ie extends R {
        ...
        _enforceFocus() {
            ...
            H.on(document, "focusin.bs.modal", t => {
                document === t.target || this._element === t.target || this
                    ._element
                    .contains(t.target) || this
                    ._element
                    .focus()
            })
        }
        ...
        static jQueryInterface(t, e) {
            return this.each((function () {
                const i = Ie.getInstance(this) || new Ie(
                    this,
                    "object" == typeof t
                        ? t
                        : {}
    ...
    class Me extends R {
        ...
        static jQueryInterface(t) {
            return this.each((function () {
                const e = w.get(this, "bs.offcanvas") || new Me(
                    this,
                    "object" == typeof t
                        ? t
                        : {}
    ...
    H.on(window, "load.bs.offcanvas.data-api", () => {
        t
            .find(".offcanvas.show")
            .forEach(t => (w.get(t, "bs.offcanvas") || new Me(t)).show())
    }),
    b(Me);
    const He = new Set([
            "background",
    ...
    class Je extends Xe {
        ...
        _getContent() {
            return this
                ._element
                .getAttribute("data-bs-content") || this._config.content
        }
        _cleanTipClass() {
            const t = this.getTipElement(),
                e = t
    ...
    class ii extends R {
        ...
        static jQueryInterface(t) {
            return this.each((function () {
                const e = ii.getInstance(this) || new ii(
                    this,
                    "object" == typeof t
                        ? t
                        : {}
    ...
    class ni extends R {
        ...
        show() {
            ...
            i
                ? this._activate(i, i.parentNode, r)
                : r()
        }
        _activate(e, i, n) {
            const s = (
